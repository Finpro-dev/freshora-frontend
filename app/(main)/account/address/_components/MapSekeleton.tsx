function SkeletonMap() {
  return (
    <div className="relative w-full h-60 sm:h-100 overflow-hidden rounded-lg bg-gray-200 dark:bg-gray-700 mb-5">
      ...
      <div className="absolute bottom-2 right-2 text-xs text-gray-400 dark:text-gray-500 bg-white/60 dark:bg-black/40 px-2 py-1 rounded">
